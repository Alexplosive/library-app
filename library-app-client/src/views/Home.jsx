    ...
    <section className="h-full">
      ...
      <section className="flex justify-evenly text-4xl h-4/6">
        <section className="flex-1 m-5 border border-current rounded-xl h-full bg-purple-700">
          ...
          <Link to={'/books'}><h6 className="p-10 text-center font-bold underline cursor-pointer">Click here to access the book database</h6></Link>
        </section>
        <section className="flex-1 m-5 border border-current rounded-xl h-full bg-purple-700">
          ...
          <Link to={'/articles'}><h6 className="p-10 text-center font-bold underline cursor-pointer">Click here to access the article database</h6></Link>
        </section>
        <section className="flex-1 m-5 border border-current rounded-xl h-full bg-purple-700">
          ...
          <Link to={'/papers'}><h6 className="p-10 text-center font-bold underline cursor-pointer">Click here to access the article database</h6></Link>
        </section>
      </section>
    </section>
  )
